...
var UserProfile = React.createClass({
  ...
  render: function() {
    return (
      <div>
        <h3>Bio for {this.props.username}</h3>
        {this.props.bio.avatar_url ? <li className="list-group-item"> <img src={this.props.bio.avatar_url} className="img-rounded img-responsive"/></li> : null}
